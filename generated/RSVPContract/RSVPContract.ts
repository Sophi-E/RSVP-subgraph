...
export class RSVPContract__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class RSVPContract extends ethereum.SmartContract {
  static bind(address: Address): RSVPContract {
    return new RSVPContract("RSVPContract", address);
  }

  idToEvent(param0: Bytes): RSVPContract__idToEventResult {
    ...
    return new RSVPContract__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(
    param0: Bytes
  ): ethereum.CallResult<RSVPContract__idToEventResult> {
    ...
    return ethereum.CallResult.fromValue(
      new RSVPContract__idToEventResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
